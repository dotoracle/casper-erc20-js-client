...
declare class ERC20Client extends CasperContractClient {
    ...
    readRequestIndex(id: string): Promise<any>;
    ...
    requestBridgeBack(keys: Keys.AsymmetricKey, amount: string, toChainId: string, receiverAddress: string, paymentAmount: string, ttl?: number): Promise<string>;
    createUnsignedRequestBridgeBack(publicKey: CLPublicKey, amount: string, toChainId: string, receiverAddress: string, paymentAmount: string, ttl?: number): Promise<{
